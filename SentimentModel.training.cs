...
namespace MLlearning
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\Marcus\source\repos\C#\MLlearning\yelp_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.056401856F,L2Regularization=0.037493646F,LabelColumnName=@"col1",FeatureColumnName=@"Features"}))      
